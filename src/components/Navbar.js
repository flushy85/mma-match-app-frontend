...
const NavigationBar = ({ user, handleLogout }) => {
  return (
    <Navbar className="navbar" bg="light" variant="light" expand="lg" fixed="top">
      <Link to="/"><Navbar.Brand className="brand">MMApp<FistIcon className="nav-icon"/></Navbar.Brand></Link>
